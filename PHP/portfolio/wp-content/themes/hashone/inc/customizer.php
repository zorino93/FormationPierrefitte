...
function hashone_customize_register( $wp_customize ) {
	...
	$wp_customize->add_control(
		new Hashone_Dropdown_Chooser(
			...
			array(
				...
				'description'   => __( 'Only appears in sticky header in featured frontpage.', 'hashone' )
			)
		)
	);
	...
	//BLOG SETTINGS
	$wp_customize->add_section(
		'hashone_blog_section',
		array(
			'title'			=> __( 'Blog Settings', 'hashone' ),
			'panel'         => 'hashone_general_settings_panel'
		)
	);
	...
	$wp_customize->add_control(
		'hashone_blog_format', 
		array(
			'label'    => __( 'Blog Content Format', 'hashone' ),
	...
	$wp_customize->add_setting(
		...
		array(
			'default'			=> __( 'Email: info@website.com', 'hashone' ),
			'sanitize_callback' => 'hashone_sanitize_text'
		)
	);
